# HC-SR05 ULTRASONIC SENSOR (avståndssensor)

# CREDIT / SOURCE CODE / Inspiration:
...
def distance_measure(sensitivity_cm):
    ...
    if distance < sensitivity_cm:
        pycom.heartbeat(False)   # enable the heartbeat LED
